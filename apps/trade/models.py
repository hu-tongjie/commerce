...
#     order_user = models.ForeignKey('user_operation.user',models.DO_NOTHING) # 用户id
#     order_address = models.ForeignKey('user_operation.address',models.DO_NOTHING) # 收件地址id
#     payment = models.CharField(max_length=16) # 支付方式
#     numbers = models.IntegerField() # 数量
#     total_money = models.FloatField() # 总金额
#     freight = models.FloatField() # 运费
#     pay_status = models.BooleanField(default=False) # 支付状态
#     create_time = models.DateTimeField(auto_now_add=True,null=True) # 订单创建时间
#
#
# class order_goods(models.Model):
#     id = models.AutoField(primary_key=True)
#     orders = models.ForeignKey('trade.order_info',models.DO_NOTHING) # 订单id
#     order_SKU = models.ForeignKey('goods.Goods_SKU',models.DO_NOTHING) # sku商品id
#     numbers = models.IntegerField() # 数量
#     prices = models.FloatField() # 价格
#     comment = models.CharField(max_length=255) # 评论